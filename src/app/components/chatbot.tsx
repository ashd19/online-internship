...
`;
  ...
  getFAQResponse(userMessage: string) {
    const message = userMessage.toLowerCase();

    const faqResponses = {
      "cost|price|fee|payment":
        "The test costs ₹250 + GST as a one-time fee. Payment is secure and GST compliant.",
      "time|duration|minutes":
        "You'll have 30 minutes to complete 35 questions. The timer starts once you begin the test.",
      "questions|format|test":
        "The assessment contains 35 carefully designed questions to evaluate your skills and knowledge for internship readiness.",
      "result|score|ranking":
        "You'll receive instant results with detailed analysis and merit-based ranking immediately after completing the test.",
      "register|signup|account":
        "To register, visit our student login page, verify your email, and complete your profile before taking the test.",
      "cheat|monitoring|proctored":
        "We use advanced anti-cheating technology and secure proctoring to ensure fair assessment for all students.",
      "support|help|contact":
        "For additional support, please email us at support@onlyinternship.in or use the contact information on our website.",
    };
