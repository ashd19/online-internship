        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
              Empowering retail excellence through innovative solutions and
              comprehensive training programs. Building the future of retail,
              one professional at a time.
            </p>
            <div className="flex space-x-2 sm:space-x-3">
              <a
                href="#"
                className="w-8 h-8 sm:w-10 sm:h-10 bg-[#3A2F1F] rounded-full flex items-center justify-center hover:bg-[#D4AF37] transition-colors"
              >
            ...
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                <li key={link}>
                  <a
                    href="#"
                    className="text-gray-300 hover:text-[#D4AF37] transition-colors flex items-center text-sm sm:text-base"
                  >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center">
                ...
                <span className="text-gray-300 ml-0 sm:ml-2 text-sm sm:text-base">
                  Ashton Dsouza
                </span>
              </div>
            </div>
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4 lg:space-x-6">
              ...
              >
                ...
                <span className="break-all">ashtondsouza192@gmail.com</span>
              </a>
              <a
                href="#"
                className="text-gray-300 hover:text-[#D4AF37] transition-colors flex items-center text-sm sm:text-base"
